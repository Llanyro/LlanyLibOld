...
LlanyLib::Juego::Objetos::Items::Item* LlanyLib::Juego::Objetos::Items::Contenedor::addProtected(Item* item)
{
	Item* resultado = item;
...
LlanyLib::Juego::Objetos::Items::Contenedor::Contenedor() : Item()
{
...
inline bool LlanyLib::Juego::Objetos::Items::Contenedor::operator=(const Contenedor& other)
{
...
LlanyLib::Juego::Objetos::Items::Contenedor::~Contenedor()
{
	delete this->listaContenedor;
}
#pragma endregion
#pragma region Getters
bool LlanyLib::Juego::Objetos::Items::Contenedor::getCapacidadOcupada() const
{
	return this->capacidadOcupada;
}
bool LlanyLib::Juego::Objetos::Items::Contenedor::getCapacidadMaxima() const
{
	return this->capacidadMaxima;
}
#pragma endregion
#pragma region Contenedor
void LlanyLib::Juego::Objetos::Items::Contenedor::clear()
{
...
#pragma region Protected
bool LlanyLib::Juego::Objetos::Items::Contenedor::sePuedeAñadir(const Item* item) const
{
	return (item->getTipoDeMaterial() == this->tipoDeMaterialContenible
		&& this->cabeItem(item));
}
bool LlanyLib::Juego::Objetos::Items::Contenedor::cabeItem(const Item* item) const
{
	return (this->capacidadMaxima >=
...
#pragma endregion
#pragma region Contenedor
LlanyLib::Juego::Objetos::Items::Item* LlanyLib::Juego::Objetos::Items::Contenedor::add(Item* item)
{
...
LlanyLib::Juego::Objetos::Items::Item* LlanyLib::Juego::Objetos::Items::Contenedor::extractItem(const size_t& pos)
{
...
LlanyLib::Juego::Objetos::Items::Item* LlanyLib::Juego::Objetos::Items::Contenedor::extractItem(const size_t& pos, const double& cantidad)
{
...
#pragma endregion
#pragma region Other
LlanyLib::Juego::Objetos::Items::Item* LlanyLib::Juego::Objetos::Items::Contenedor::clone() const
{
	return new Contenedor(*this);
}
LlanyLib::Basic::Objetos::JSONBuilder* LlanyLib::Juego::Objetos::Items::Contenedor::toJSONBuilder() const
{
...
LlanyLib::Basic::Objetos::String* LlanyLib::Juego::Objetos::Items::Contenedor::toJSON() const
{
...
void LlanyLib::Juego::Objetos::Items::Contenedor::deleteItem()
{
	delete this;
}
int LlanyLib::Juego::Objetos::Items::Contenedor::compare(const Contenedor& other) const
{
...
bool LlanyLib::Juego::Objetos::Items::Contenedor::similar(const Contenedor& other) const
{
	bool temp = false;
...
bool LlanyLib::Juego::Objetos::Items::Contenedor::equals(const Contenedor& other) const
{
	bool temp = false;
	if (&other != nullptr && this != nullptr)
...
bool LlanyLib::Juego::Objetos::Items::Contenedor::igualMenosCantidad(const Contenedor& other) const
{
	bool temp = false;
	if (&other != nullptr && this != nullptr)
...
bool LlanyLib::Juego::Objetos::Items::Contenedor::operator==(const Contenedor& other) const
{
